...
def run(i, config, net, device):
    ...
    def log_validation_results(engine):
        ...
        print("Validation Result: ----------------->  Loss: {:.4f}, Accuracy: {:.4f}, F1: {:.4f}".format(m['loss'], m['accuracy'], m['f1']))
...
if __name__ == '__main__':
    ...
    for i, config in enumerate(configs):
        ...
        print("Cached memory: {}, Allocated memory: {}".format(torch.cuda.memory_cached(device=1), torch.cuda.memory_allocated(device=1)))
